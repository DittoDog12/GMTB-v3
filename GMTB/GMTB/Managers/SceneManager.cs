...
namespace GMTB.Managers
{
    public class SceneManager : ISceneManager
    {
        ...
        #region Constructor      
        public SceneManager(IEntityManager em, Microsoft.Xna.Framework.Content.ContentManager _content)
        {
        ...
        public void newEntity(IEntity _createdEntity, int _x, int _y)
        {
            ...
            for (int i = 1; i < mEntityManager.TotalEntities(); i++)
                    //mEntities[i].Texture = Content.Load<Texture2D>(mEntities[i].Texturename);
                    mEntityManager.GetEntity(i).Texture = Content.Load<Texture2D>(mEntities[i].Texturename);
        ...
        public void Draw(SpriteBatch _spriteBatch)
        {
            ...
            for (int i = 0; i < mEntityManager.TotalEntities(); i++)
                    //mEntities[i].Draw(_spriteBatch);
